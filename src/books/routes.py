...
async def update_book(
    ...
    update_book = await book_service.update_book(book_uid, book_update_date, session)
...
@book_router.delete(
    "/{book_uid}", status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(role_checker)]
)
